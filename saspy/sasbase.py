...
class SASsession:
    ...
    def submit(self, code, results="html", prompt={}):
        ...
        out = self.stdin.write(mj+b'\n'+pcodei.encode(encoding=self.sascfg.sasenc)+pcodeiv.encode(encoding=self.sascfg.sasenc)+code.encode(encoding=self.sascfg.sasenc)+b'\n'+pcodeo.encode(encoding=self.sascfg.sasenc)+b'\n'+mj)
